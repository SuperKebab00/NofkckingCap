...
export function getDom() {
  return {
    ...
    sectionItemsForm: document.querySelector("[data-section-items-form]"),
    sectionItemsJson: document.querySelector("[data-section-items-json]"),
    sectionItemsKey: document.querySelector("[data-section-items-key]"),
    sectionItemsLoad: document.querySelector("[data-section-items-load]"),
    ...
    siteShopDynamicCopy: document.querySelector("[data-shop-dynamic-copy]"),
